1/* La función CodeHard recibe un parámetro entero, 
retorna "Code" si el número es divisible entre 3
y retorna "Hard" si el número es divisble entre 5
y retorna CodeHard si el número es divisible entre 3 y 5
en cualquier otro caso retorna el mismo número
*/
